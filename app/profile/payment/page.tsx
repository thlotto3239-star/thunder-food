...
import { getPaymentMethods } from "@/app/actions/customer"
import ProfilePaymentClient from "./ProfilePaymentClient"
    ...
    <div className="min-h-screen bg-[#f9f6f5] pb-36">
      <header className="sticky top-0 z-40 bg-white shadow-sm border-b border-gray-100">
        <div className="mx-auto flex max-w-md items-center gap-4 px-4 py-3">
          ...
          <h1 className="text-xl font-bold font-thai text-gray-900">วิธีชำระเงิน</h1>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-md px-4 py-6">
        {error ? (
          ...
          <ProfilePaymentClient initialMethods={data || []} />
        )}
      </main>
